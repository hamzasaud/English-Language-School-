...
export default function Pricing() {
  ...
  const faqs = [
    {
      question: currentLocale === 'id' ? 'Apakah ada biaya pendaftaran?' : 'Is there a registration fee?',
    ...
    {
      question: currentLocale === 'id' ? 'Apakah bisa membayar per semester?' : 'Can I pay per semester?',
      answer: currentLocale === 'id' 
    ...
    {
      question: currentLocale === 'id' ? 'Apa yang terjadi jika saya melewatkan kelas?' : 'What happens if I miss a class?',
      answer: currentLocale === 'id' 
    ...
    {
      question: currentLocale === 'id' ? 'Apakah ada garansi uang kembali?' : 'Is there a money-back guarantee?',
      answer: currentLocale === 'id' 
    ...
    {
      question: currentLocale === 'id' ? 'Bisakah pindah ke kelas yang berbeda?' : 'Can I switch to a different class?',
      answer: currentLocale === 'id' 
    ...
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">
              {content.navigation[currentLocale].pricing}
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              {currentLocale === 'id' ? 'Metode Pembayaran' : 'Payment Methods'}
            </h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              {currentLocale === 'id' ? 'Pertanyaan yang Sering Diajukan' : 'Frequently Asked Questions'}
            </h2>
            <p className="text-lg text-gray-600">
              {currentLocale === 'id' 
      ...
      <section className="py-16 bg-primary-600 text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            >
              {currentLocale === 'id' ? 'Hubungi untuk Penawaran Khusus' : 'Contact for Special Offer'}
            </a>
            <a
